...
def download_extract_copy(input_folder, mod_name):
    ...
    # URL of the ZIP file
    zip_url = "https://github.com/fayaz12g/aar-files/raw/main/mm2/Mario2.zip"
    zip2_url = "https://github.com/fayaz12g/aar-files/raw/main/mm2/Controllers.zip"

    username = getpass.getuser()
    directory_path = f"C:/Users/{username}/AppData/Roaming/AnyAspectRatio/perm/mm2"
    ...
    perm_folder = f"C:/Users/{username}/AppData/Roaming/AnyAspectRatio/perm/mm2"
    zip_file_source = os.path.join(perm_folder, "Mario2.zip")
